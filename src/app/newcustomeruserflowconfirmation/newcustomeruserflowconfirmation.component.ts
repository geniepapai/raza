...
@Component({
  selector: 'app-newcustomeruserflowconfirmation',
  templateUrl: './newcustomeruserflowconfirmation.component.html',
  styleUrls: ['./newcustomeruserflowconfirmation.component.css']
})
export class NewcustomeruserflowconfirmationComponent implements OnInit {
